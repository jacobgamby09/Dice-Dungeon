      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: mergeLevel >= 3
            ...
            : mergeLevel === 2
              ? `4px 4px 0 ${s.shadow}, 0 0 15px rgba(148,163,184,0.8), inset 0 0 12px rgba(255,255,255,0.7)`
              : mergeLevel === 1
                ? `4px 4px 0 ${s.shadow}, 0 0 10px rgba(205,127,50,0.5), inset 0 0 8px rgba(205,127,50,0.3)`
                : `4px 4px 0 ${s.shadow}`,
          border: mergeLevel >= 3
            ? '4px solid #fbbf24'
            : mergeLevel === 2
